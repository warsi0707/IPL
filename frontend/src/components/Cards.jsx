...
import { loadingAtom, productAtom } from "../atoms/Atoms";
...
export default function Cards() {
  ...
  const GetData = async () => {
    const response = await fetch(`${backendUrl}/v1/api/product/item`, {
      method: "GET",
    });
  ...
  return (
    <>
      ...
      <Link
        to={"/products"}
        className="text-xl flex justify-end mr-20 underline text-blue-600 py-10"
      >
        All Products...
      </Link>
    </>
